 ...
 * @Description: TODO
 * @Author zhouxiangfu
 * @Date 2020/10/10 3:23 下午
 * @Version V1.0
 **/


import com.iskeen.project.crawler.common.config.SpringBeanFactory;
...
import com.iskeen.project.crawler.core.job.task.ITask;
...
public class ScheduleJob extends QuartzJobBean {
  ...
  protected void executeInternal(JobExecutionContext context) throws JobExecutionException {
    ...
    //获取spring bean
    ScheduleJobLogService scheduleJobLogService = (ScheduleJobLogService) SpringBeanFactory
    ...
    try {
      ...
      ITask target = SpringBeanFactory.getBean(scheduleJob.getBeanName());
